...
namespace EditorHelpersTests
{
    ...
    public:
        ...
        {
            // Arrange
            Shortcut s1{VK_LCONTROL, 'B'};
            Shortcut s2{VK_CONTROL, 'B'};
